...
def contains(container: list[int], containee: list[int]) -> bool:
    return containee[0] >= container[0] and containee[1] <= container[1]
...
def main() -> None:
    ...
    with open(SOURCE_FILE) as f:
        for i, source_line in enumerate(f.readlines(), start=1):
            ...
            if contains(boundaries_a, boundaries_b) or contains(boundaries_b, boundaries_a):
